...
### Description
A versatile piece that blurs the line between a long sleeve tee and a light cover-up. Made from a soft, fine-gauge cotton blend knit that is thin, breathable, and provides gentle sun protection. Features classic navy stripes for a fresh, youthful look. The relaxed, oversized fit (Size S fits up to approx. 140 lbs) and twist rope detail offer both comfort and style. Perfect for casual days or beach cover-ups.

**Ideal for:** Stores looking for multi-functional, season-transition pieces that are size-inclusive.

**Color:** Navy Stripe (as pictured)
...
### 描述
一款融合长袖T恤与轻薄罩衫功能的多用途单品。采用柔软细腻的棉混纺针织布，轻薄亲肤透气，具有一定防晒效果。藏青色色织条纹清新减龄。宽松大件版型（S码可适配至约140斤），搭配扭绳细节，兼顾舒适与造型感。适用于日常休闲或作为度假防晒衫。
